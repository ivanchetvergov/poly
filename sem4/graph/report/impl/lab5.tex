...
\subsubsection{EulerianCycle: проверка, достройка и нахождение эйлерова цикла}
...
\subsubsection{CutSystem: фундаментальная система разрезов и симметрическая разность}
